...
public class BattleScreenDriver {
	...
	public static void main(int xPos, int yPos, byte enemyLevelTier) {
		...
		byte enemyTier = enemyLevelTier;//4 = Kitsune boss fight; 1 = tier one enemy battle
		byte[] enemyLevels = new byte[] {5,2,4,7};//says what level each enemy will be in the order of enemy1, enemy2, enemy3,enemy4
		short[] enemyIDs = new short[] {1,0,1,1};//contains the ID of each enemy for a tier so the battle manager knows which enemies ot spawn
